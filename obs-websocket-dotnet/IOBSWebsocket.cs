...
namespace OBSWebsocketDotNet
{
    ...
    public interface IOBSWebsocket
    {
        ...
        void SetSourceFilterSettings(string sourceName, string filterName, JsonElement filterSettings, bool overlay = false);
        ...
        /// <param name="filterSettings">JsonElement holding filter settings object</param>
        void CreateSourceFilter(string sourceName, string filterName, string filterKind, JsonElement filterSettings);
        ...
        void SetCurrentSceneTransitionSettings(JsonElement transitionSettings, bool overlay);
        ...
        /// <param name="sceneItemTransform">JsonElement holding transform settings</param>
        void SetSceneItemTransform(string sceneName, int sceneItemId, JsonElement sceneItemTransform);
        ...
        void SendStreamCaption(string captionText);        /// <summary>
        ...
        int DuplicateSceneItem(string sceneName, int sceneItemId, string destinationSceneName = null);
        ...
        void BroadcastCustomEvent(JsonElement eventData);
        ...
        /// <param name="inputSettings">JsonElement holding the settings object to initialize the input with</param>
        ...
        int CreateInput(string sceneName, string inputName, string inputKind, JsonElement inputSettings, bool? sceneItemEnabled);
        ...
        JsonElement GetInputDefaultSettings(string inputKind);
        ...
        /// </summary>
        /// <param name="inputName">Name of the input</param>
        /// <param name="inputAudioTracks">JsonElement holding track settings to apply</param>
        void SetInputAudioTracks(string inputName, JsonElement inputAudioTracks);
        ...
        JsonElement GetPersistentData(string realm, string slotName);
        ...
        void SetPersistentData(string realm, string slotName, JsonElement slotValue);
        ...
        /// <returns></returns>
        JsonElement GetProfileParameter(string parameterCategory, string parameterName);
        ...
        JsonElement GetSourceFilterDefaultSettings(string filterKind);
        ...
        JsonElement CallVendorRequest(string vendorName, string requestType, JsonElement? requestData = null);
        ...
        /// <param name="inputSettings">Object of settings to apply</param>
        /// <param name="overlay">True == apply the settings on top of existing ones, False == reset the input to its defaults, then apply settings.</param>
        void SetInputSettings(string inputName, JsonElement inputSettings, bool overlay = true);
        ...
        List<JsonElement> GetInputPropertiesListPropertyItems(string inputName, string propertyName);
        ...
        List<JsonElement> GetGroupSceneItemList(string sceneName);
        ...
        /// <param name="sceneItemId">Numeric ID of the scene item</param>
        /// <returns>Object containing scene item transform info</returns>
        JsonElement GetSceneItemTransformRaw(string sceneName, int sceneItemId);
        ...
        JsonElement SendRequest(string requestType, JsonElement? additionalFields = null);
