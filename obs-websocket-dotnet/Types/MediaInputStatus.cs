...
namespace OBSWebsocketDotNet.Types
{
    ...
    public class MediaInputStatus
    {
        ...
        /// <summary>
        /// Instantiate from JsonElement
        /// </summary>
        /// <param name="body"></param>
        public MediaInputStatus(JsonElement body)
        {
            StateString = JsonHelper.GetPropertyValue<string>(body, "mediaState");
            Duration = JsonHelper.GetPropertyValue<long?>(body, "mediaDuration");
            Cursor = JsonHelper.GetPropertyValue<long?>(body, "mediaCursor");
        }
